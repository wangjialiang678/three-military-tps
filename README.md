...
- **[ARCHITECTURE.md](./ARCHITECTURE.md)** —— 技术结构、原理、能做/不能做、定制指南、各类游戏适配（含开放世界 / GTA 类玩法分析）、常见改动配方。**想改这个项目、想搞懂它怎么运作，先读这份。**
- **[AGENTS.md](./AGENTS.md)** —— 给 AI 编码代理的精简操作手册（AI 工具会自动读取），项目地图 + 改动定位 + 约定 + 验证方式。
